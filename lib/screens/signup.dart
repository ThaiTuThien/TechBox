...
import 'package:techbox/screens/login.dart';
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('Hãy tạo tài khoản của bạn.', style: ConstantText.descriptionText),
              SizedBox(height: 16),
              InputComponent(label: 'Họ tên', hint: 'Nhập họ tên của bạn'),
              SizedBox(height: 16),
              InputComponent(label: 'Email', hint: 'Nhập email của bạn'),
              SizedBox(height: 16),
              InputComponent(label: 'Mật khẩu', hint: 'Nhập mật khẩu của bạn', obscureText: true),
              SizedBox(height: 20),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text('Đăng nhập', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))
                      )
                  ],),
                )
            ],
